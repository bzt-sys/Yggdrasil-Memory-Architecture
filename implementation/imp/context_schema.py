...
def build_context_bundle(
    *,
    ...
    governance_proposals: Optional[List[Dict[str, Any]]] = None,
    developmental_hypotheses: Optional[List[Dict[str, Any]]] = None,
    ...
    bundle = {
        ...
        "developmental_hypotheses": developmental_hypotheses or [],
